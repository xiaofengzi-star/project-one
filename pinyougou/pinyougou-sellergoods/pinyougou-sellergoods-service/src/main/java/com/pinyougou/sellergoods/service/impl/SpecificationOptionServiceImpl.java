...
public class SpecificationOptionServiceImpl extends BaseServiceImpl<TbSpecificationOption> implements SpecificationOptionService {
    ...
    @Override
    public PageResult search(TbSpecificationOption tbSpecificationOption, Integer page, Integer rows) {
    ...
    public List<TbSpecificationOption> findBySpecId(Long specId) {
        ...
        return specificationOptionMapper.select(tbSpecificationOption);
    }
}
